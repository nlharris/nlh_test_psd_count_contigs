...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'nlh_test_psd_count_contigs'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from nlh_test_psd_count_contigs.nlh_test_psd_count_contigsImpl import nlh_test_psd_count_contigs
impl_nlh_test_psd_count_contigs = nlh_test_psd_count_contigs(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['nlh_test_psd_count_contigs.count_contigs_async'] = ['nlh_test_psd_count_contigs', 'count_contigs']
async_check_methods['nlh_test_psd_count_contigs.count_contigs_check'] = ['nlh_test_psd_count_contigs', 'count_contigs']
sync_methods['nlh_test_psd_count_contigs.count_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'nlh_test_psd_count_contigs'
        ...
        self.rpc_service.add(impl_nlh_test_psd_count_contigs.count_contigs,
                             name='nlh_test_psd_count_contigs.count_contigs',
                             types=[basestring, basestring])
        self.method_authentication['nlh_test_psd_count_contigs.count_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "nlh_test_psd_count_contigs but no authentication header was passed"
                            raise err
