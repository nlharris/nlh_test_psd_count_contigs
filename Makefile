SERVICE = nlh_test_psd_count_contigs
SERVICE_CAPS = nlh_test_psd_count_contigs
SPEC_FILE = nlh_test_psd_count_contigs.spec
URL = https://kbase.us/services/nlh_test_psd_count_contigs
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
